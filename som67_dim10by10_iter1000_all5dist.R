...
# Normalized_Input<-f[1:10000,]
# Normalized_Input<-f[sample(nrow(f), 1000), ]

setwd('~/Cluster_Dupont/new_ot_1004/output/norm_input/feature_new_tls/norm_input_weighted/som67_chuyen/sombyR')
...
toc=proc.time()
toc-tic
save.image('v1118_som67_dim10by10_iter1000_all5dist.RData')
#my.sck4to10<-foreach (i=bvec,.combine='rbind') %:%
...
write.csv(cluster_alldist, file = "cluster_c2to10_all5dist_byR_20171118.csv",row.names=T)
